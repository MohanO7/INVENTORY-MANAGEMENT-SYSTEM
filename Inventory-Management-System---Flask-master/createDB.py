...
conn.execute(
    'CREATE TABLE productmovement (movementID INTEGER PRIMARY KEY, atTime TEXT, from_location TEXT, to_location TEXT, '
    'productName TEXT, qty INTEGER)')
print("Table productmovement created successfully")

conn.execute('CREATE TABLE balance (locationName TEXT, productName TEXT,'
             ' qty INTEGER,  PRIMARY KEY (locationName, productName))')
...
conn.commit()
conn.execute("INSERT INTO users VALUES('Mohan','12345')") 
conn.execute("INSERT INTO users VALUES('Ram','password-Sun')")
conn.execute("INSERT INTO users VALUES('Praveen','password-june')")"""
